        ...
        {!reviews.length ? (
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap items-end justify-between gap-3 rounded-lg bg-slate-50 p-3 dark:bg-slate-800/60">
              <div className="flex items-center gap-2"><label className="text-xs font-semibold text-slate-600 dark:text-slate-300">الشعبة</label><StyledSelect value={divisionFilter} onValueChange={setDivisionFilter} options={[{ value: "ALL", label: "كل الشعب" }, ...divisions.map((division) => ({ value: division, label: division }))]} className="h-9 w-36 rounded-lg px-2 text-xs" /></div>
